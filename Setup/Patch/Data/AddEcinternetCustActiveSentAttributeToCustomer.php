...
class AddEcinternetCustActiveSentAttributeToCustomer implements DataPatchInterface
{
    ...
    {
        return [AddEcinternetCustomerActivatedAttributeToCustomer::class];
    }
    ...
    public function apply(): void
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'ecinternet_cust_active_sent', [
            'type'         => 'int',
        ...
        if ($attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'ecinternet_cust_active_sent')) {
